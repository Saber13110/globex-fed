...
# PERF OFF — analytics importé mais route désactivée (éviter chargement widgets)
# from jarvis.interfaces.api.analytics import router as _analytics_router
from jarvis.interfaces.api.assistant_routes import router as _assistant_router
...
from jarvis.interfaces.api.globex import router as _globex_router
from jarvis.interfaces.api.workspace_globex import router as _workspace_globex_router
...
# PERF OFF — réactiver les imports + include_router ci-dessous si besoin
...
# PERF OFF — réactiver si besoin mémoire / skills / vision / analytics / proactive
...
router.include_router(_globex_router)
router.include_router(_workspace_globex_router)
